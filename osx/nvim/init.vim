...
Plug 'mhinz/vim-mix-format'                " Elixir Format
...
Plug 'tpope/vim-fireplace' " Clojure Eval
Plug 'tpope/vim-salve' " Leiningen Support
Plug 'guns/vim-clojure-static' " Clojure Syntax (Static)
Plug 'guns/vim-clojure-highlight' " Clojure Syntax (Dynamic)
...
let g:LanguageClient_serverCommands = {
    \ 'reason': ['/Users/alvivi/Projects/reason-language-server/lib/bs/native/bin.native'],
    \ 'ocaml': ['/Users/alvivi/Projects/reason-language-server/lib/bs/native/bin.native'],
    \ }
...
" More info :help sexp-explicit-mappings
